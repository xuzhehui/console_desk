...
export default {
    data(){
        return {
            ...
            tableColums:[
                {title:'小区',align:'center',key:'residential_name',fixed:'left',width:'200'},
                ...
                {title:'房间号',align:'center',key:'number',minWidth:100},
                {title:'单价',align:'center',key:'price',minWidth:100},
                {title:'预估房间工期',align:'center',key:'time',minWidth:100},
