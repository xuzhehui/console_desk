    ...
    data(){
        return {
            list:[
                ...
                {title:'小区名称',name:'Input',serverName:'id',placeholder:'请输入小区名称',value:''},
                {title:'交货日期范围',name:'Input',start_value:'',end_value:'',isDate:true,serverName:'id2',start_placeholder:'开始日期',end_placeholder:'结束日期'},
