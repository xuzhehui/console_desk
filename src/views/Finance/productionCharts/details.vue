    ...
    data(){
        return {
            ...
            tableColums:[
                ...
                {title:'产品',align:'center',key:'procedure',minWidth:100},
                {title:'部件',align:'center',key:'product',minWidth:100},
                {title:'部件是否贴标签',align:'center',key:'number_url',minWidth:150},
                {title:'测量尺寸',align:'center',key:'price',minWidth:100},
                {title:'单位',align:'center',key:'type',minWidth:100},
                {title:'芯片编号',align:'center',key:'time',minWidth:100},
                {title:'部件价格',align:'center',key:'time',minWidth:100},
                {title:'完成时间',align:'center',key:'time',fixed:'right',width:'200'},
            ],
            tableData:[],
            pageIndex:1,
            total:0,
